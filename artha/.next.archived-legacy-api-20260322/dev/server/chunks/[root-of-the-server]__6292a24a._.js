...
"[project]/src/app/api/dashboard/[id]/widget/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req, { params }) {
    ...
    try {
        const owner = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$db$2d$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pgDb"].queryOne(`SELECT id FROM user_dashboards WHERE id = $1 AND user_id = $2`, [
            id,
            userId
        ]);
        ...
        const countRow = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$db$2d$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pgDb"].queryOne(`SELECT COUNT(*)::text AS cnt FROM user_widgets WHERE dashboard_id = $1`, [
            id
        ]);
        const sortOrder = parseInt(countRow?.cnt ?? '0', 10);
        const widget = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2f$db$2d$postgres$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pgDb"].queryOne(`INSERT INTO user_widgets (dashboard_id, widget_type, title, config_json, sort_order)
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6292a24a._.js.map