...
"[project]/src/app/(app)/macros/heatmap/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const START_YEARS = Array.from({
    length: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["END_YEAR"] - __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["START_YEAR"] + 1
}, (_, i)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["START_YEAR"] + i);
...
function HeatmapPage() {
    ...
    if ($[0] !== "c838249061e770d26902952d8680b10aa63d0fb1f658a48c4ca1fcbd5885f2e5") {
        for(let $i = 0; $i < 84; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "c838249061e770d26902952d8680b10aa63d0fb1f658a48c4ca1fcbd5885f2e5";
    }
    const [asset, setAsset] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("nifty50");
    ...
    const [highlightRow, setHighlightRow] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [highlightCol, setHighlightCol] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    let t0;
    if ($[1] !== asset || $[2] !== inflationAdjusted) {
        t0 = START_YEARS.map({
            "HeatmapPage[START_YEARS.map()]": (sy)=>HOLDING_PERIODS.map({
                    "HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map()]": (hp)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeCAGR"])(asset, sy, hp, inflationAdjusted)
                }["HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map()]"])
        }["HeatmapPage[START_YEARS.map()]"]);
        $[1] = asset;
        $[2] = inflationAdjusted;
        $[3] = t0;
    } else {
    ...
    if ($[4] !== grid) {
        ...
        worst = null;
        grid.forEach({
            "HeatmapPage[grid.forEach()]": (row, ri)=>{
                row.forEach({
                    "HeatmapPage[grid.forEach() > row.forEach()]": (val, ci)=>{
                        if (val === null) {
                            return;
                        }
                ...
                }["HeatmapPage[grid.forEach() > row.forEach()]"]);
            }
        }["HeatmapPage[grid.forEach()]"]);
        $[4] = grid;
        $[5] = best;
        $[6] = worst;
    } else {
    ...
    const { bestCell, worstCell } = t1;
    let t2;
    if ($[10] !== asset) {
        t2 = ({
            "HeatmapPage[handleCellHover]": (e, startYear, holdingYears, cagr)=>{
                const corpus = cagr !== null ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["computeCorpus"])(asset, startYear, holdingYears) : null;
                setTooltip({
                    startYear,
                    holdingYears,
                    cagr,
        ...
        })["HeatmapPage[handleCellHover]"];
        $[10] = asset;
        $[11] = t2;
    } else {
        t2 = $[11];
    }
    const handleCellHover = t2;
    let t3;
    ...
    if ($[16] === Symbol.for("react.memo_cache_sentinel")) {
        t7 = ({
            "HeatmapPage[<Select>.onChange]": (e_0)=>setAsset(e_0.target.value)
        })["HeatmapPage[<Select>.onChange]"];
        $[16] = t7;
    } else {
        t7 = $[16];
    }
    ...
    if ($[17] === Symbol.for("react.memo_cache_sentinel")) {
        t8 = Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ASSET_LABELS"]);
        $[17] = t8;
    } else {
        t8 = $[17];
    }
    ...
    if ($[18] === Symbol.for("react.memo_cache_sentinel")) {
        t9 = t8.map(_HeatmapPageAnonymous);
        $[18] = t9;
    } else {
        t9 = $[18];
    }
    ...
    if ($[22] === Symbol.for("react.memo_cache_sentinel")) {
        t12 = ({
            "HeatmapPage[<Button>.onClick]": ()=>setInflationAdjusted(false)
        })["HeatmapPage[<Button>.onClick]"];
        $[22] = t12;
    } else {
        t12 = $[22];
    }
    const t13 = !inflationAdjusted ? "selected" : "outline";
    let t14;
    if ($[23] !== t13) {
    ...
    if ($[25] === Symbol.for("react.memo_cache_sentinel")) {
        t15 = ({
            "HeatmapPage[<Button>.onClick]": ()=>setInflationAdjusted(true)
        })["HeatmapPage[<Button>.onClick]"];
        $[25] = t15;
    } else {
        t15 = $[25];
    }
    const t16 = inflationAdjusted ? "selected" : "outline";
    let t17;
    if ($[26] !== t16) {
    ...
    let t19;
    if ($[31] !== asset || $[32] !== inflationAdjusted) {
        t19 = ({
            "HeatmapPage[<Button>.onClick]": ()=>navigator.clipboard.writeText(`${window.location.origin}/macros/heatmap?asset=${asset}&real=${inflationAdjusted}`)
        })["HeatmapPage[<Button>.onClick]"];
        $[31] = asset;
        $[32] = inflationAdjusted;
        $[33] = t19;
    } else {
        t19 = $[33];
    }
    ...
    let t30;
    if ($[48] !== highlightCol) {
        t30 = HOLDING_PERIODS.map({
            "HeatmapPage[HOLDING_PERIODS.map()]": (hp_0, ci_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                    className: "px-2 py-2 text-center font-medium border-b cursor-pointer transition-colors",
                    style: {
                        borderColor: "var(--border)",
                        color: highlightCol === ci_0 ? "var(--accent-brand)" : "var(--text-muted)",
                        background: highlightCol === ci_0 ? "var(--accent-subtle)" : "var(--surface)",
                        minWidth: 52
                    },
                    onClick: {
                        "HeatmapPage[HOLDING_PERIODS.map() > <th>.onClick]": ()=>setHighlightCol(highlightCol === ci_0 ? null : ci_0)
                    }["HeatmapPage[HOLDING_PERIODS.map() > <th>.onClick]"],
                    children: [
                        hp_0,
                        "yr"
                    ]
        ...
        }["HeatmapPage[HOLDING_PERIODS.map()]"]);
        $[48] = highlightCol;
        $[49] = t30;
    } else {
        t30 = $[49];
    ...
    let t32;
    if ($[52] !== bestCell?.col || $[53] !== bestCell?.row || $[54] !== grid || $[55] !== handleCellHover || $[56] !== highlightCol || $[57] !== highlightRow || $[58] !== worstCell?.col || $[59] !== worstCell?.row) {
        t32 = START_YEARS.map({
            "HeatmapPage[START_YEARS.map()]": (sy_0, ri_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                            ...
                            style: {
                                background: highlightRow === ri_0 ? "var(--accent-subtle)" : "var(--surface)",
                                borderColor: "var(--border)",
                                color: highlightRow === ri_0 ? "var(--accent-brand)" : "var(--text-secondary)"
                            },
                            onClick: {
                                "HeatmapPage[START_YEARS.map() > <td>.onClick]": ()=>setHighlightRow(highlightRow === ri_0 ? null : ri_0)
                            }["HeatmapPage[START_YEARS.map() > <td>.onClick]"],
                            children: sy_0
                        }, void 0, false, {
                            fileName: "[project]/src/app/(app)/macros/heatmap/page.tsx",
                            lineNumber: 414,
                        ...
                        HOLDING_PERIODS.map({
                            "HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map()]": (hp_1, ci_1)=>{
                                const cagr_0 = grid[ri_0][ci_1];
                                const isBest = bestCell?.row === ri_0 && bestCell?.col === ci_1;
                                const isWorst = worstCell?.row === ri_0 && worstCell?.col === ci_1;
                                const isHighlighted = highlightRow === ri_0 || highlightCol === ci_1;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                    className: "px-1 py-1 text-center font-mono cursor-pointer transition-all relative",
                                    style: {
                                        background: cagr_0 !== null ? getColor(cagr_0) : "var(--surface-elevated)",
                                        color: cagr_0 !== null ? getTextColor(cagr_0) : "var(--text-muted)",
                                    ...
                                    onMouseEnter: {
                                        "HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map() > <td>.onMouseEnter]": (e_1)=>handleCellHover(e_1, sy_0, hp_1, cagr_0)
                                    }["HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map() > <td>.onMouseEnter]"],
                                    onMouseLeave: {
                                        "HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map() > <td>.onMouseLeave]": ()=>setTooltip(null)
                                    }["HeatmapPage[START_YEARS.map() > HOLDING_PERIODS.map() > <td>.onMouseLeave]"],
                                    children: cagr_0 !== null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "relative",
                                        children: [
                                            cagr_0.toFixed(1),
                                            "%",
                                            ...
                                            isWorst && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t38;
    if ($[69] !== bestCell) {
        t38 = bestCell && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "text-xs",
            style: {
                color: "var(--text-secondary)"
            },
    ...
    let t39;
    if ($[71] !== worstCell) {
        t39 = worstCell && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "text-xs",
            style: {
                color: "var(--text-secondary)"
            },
    ...
    let t41;
    if ($[76] !== asset || $[77] !== tooltip) {
        t41 = tooltip && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: tooltip.cagr !== null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$india$2d$historical$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ASSET_LABELS"][asset],
                            " — ",
                            tooltip.startYear,
                            " for ",
                    ...
                    tooltip.corpus && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        style: {
                            color: "var(--text-secondary)"
                        },
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                ...
                                children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatINR"])(tooltip.corpus)
                            }, void 0, false, {
                                fileName: "[project]/src/app/(app)/macros/heatmap/page.tsx",
                                lineNumber: 549,
                                columnNumber: 28
    ...
    let t42;
    if ($[79] !== t22 || $[80] !== t34 || $[81] !== t40 || $[82] !== t41) {
...
_s(HeatmapPage, "YNa89l2cEZ2SMo1I48BDHh+wQqM=");
_c = HeatmapPage;
function _HeatmapPageAnonymous2(l) {
...
function _HeatmapPageAnonymous(k) {
...
var _c;
__turbopack_context__.k.register(_c, "HeatmapPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_343abced._.js.map