...
"[project]/src/lib/screener/indicators.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/components/screener/formula-utils.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/screener/indicators.ts [app-client] (ecmascript)");
;
// ─── Fuzzy Search ────────────────────────────────────────────────────────────
/**
...
function searchAutocomplete(query, context = 'start') {
    ...
    if (context === 'start' || context === 'after_operator') {
        for (const ind of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"]){
            ...
            if (bestMatch.score > 0) {
                const category = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"].find((c)=>c.id === ind.categoryId);
    ...
    if (context === 'after_indicator') {
        for (const op of __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"]){
    ...
    switch(context){
        case 'start':
            ...
            return [
                ...
                'pe',
                'mcap'
            ].map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === id)).filter((ind)=>!!ind).map((ind)=>{
                const category = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"].find((c)=>c.id === ind.categoryId);
                return {
                    type: 'indicator',
                    id: ind.id,
        ...
        case 'after_indicator':
            ...
            return [
                ...
                'cb',
                'between'
            ].map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find((o)=>o.id === id)).filter((op)=>!!op).map((op)=>({
                    type: 'operator',
                    id: op.id,
                    label: op.label,
                    category: 'Operator',
...
function detectContext(input) {
    ...
    // Check for operators
    const hasOperator = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].some((op)=>trimmed.includes(` ${op.dslOp} `) || trimmed.includes(` ${op.dslOp}`) || trimmed.endsWith(op.dslOp));
    if (hasOperator) {
        // Check if there's a value after the operator
        const lastToken = trimmed.split(/\s+/).pop() || '';
        const isOperator = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].some((op)=>op.dslOp === lastToken);
        return isOperator ? 'after_operator' : 'after_value';
    }
    // Check if we have an indicator name
    const hasIndicator = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].some((ind)=>trimmed.startsWith(ind.dslName) || trimmed.includes(` ${ind.dslName}`));
    if (hasIndicator) {
...
"[project]/src/components/screener/FormulaAutocomplete.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/screener/indicators.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$formula$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screener/formula-utils.ts [app-client] (ecmascript)");
;
...
function Highlight(t0) {
    ...
    if ($[0] !== "899b8761348752ab9573a8bc79f93dc4b3de5c2470775ae4a2b217be12dd6487") {
        for(let $i = 0; $i < 6; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "899b8761348752ab9573a8bc79f93dc4b3de5c2470775ae4a2b217be12dd6487";
    }
    const { text, indices } = t0;
    let t1;
    if ($[1] !== indices || $[2] !== text) {
        const parts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$formula$2d$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMatchIndices"])(text, indices);
        t1 = parts.map(_HighlightPartsMap);
        $[1] = indices;
        $[2] = text;
        $[3] = t1;
    } else {
...
_c = Highlight;
// ─── category colour map ─────────────────────────────────────────────────────
function _HighlightPartsMap(p, i) {
    return p.isMatch ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
function buildItems(mode, query) {
    if (mode === 'operator') {
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].map((op)=>{
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].filter((ind)=>ind.supported).map((ind)=>{
        ...
        const cat = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"].find((c)=>c.id === ind.categoryId);
        let dslExample = ind.dslName;
...
function FormulaAutocomplete(t0) {
    _s();
    ...
    const { mode, query, onSelect, onClose, position, anchorId } = t0;
    const ref = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const selRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const valuesScrollRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    let t1;
    ...
    const categoryRefs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(t1);
    ...
    const [focusPanel, setFocusPanel] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("value");
    let t2;
    if ($[2] !== position) {
        t2 = position || {
            top: 0,
    ...
    const [currentPos, setCurrentPos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t2);
    let t3;
    let t4;
    if ($[4] !== anchorId) {
        t3 = ({
            "FormulaAutocomplete[useEffect()]": ()=>{
                if (!anchorId) {
                    return;
                }
                const update = {
                    "FormulaAutocomplete[useEffect() > update]": ()=>{
                ...
                const timeout = setTimeout({
                    "FormulaAutocomplete[useEffect() > setTimeout()]": ()=>clearInterval(timer)
                }["FormulaAutocomplete[useEffect() > setTimeout()]"], 2000);
    ...
    if ($[13] !== onClose) {
        t9 = ({
            "FormulaAutocomplete[useEffect()]": ()=>{
                const handler = {
                    "FormulaAutocomplete[useEffect() > handler]": (e)=>{
                        if (ref.current && !ref.current.contains(e.target)) {
                            onClose();
                        }
                    }
                }["FormulaAutocomplete[useEffect() > handler]"];
    ...
    let t11;
    if ($[16] !== mode || $[17] !== query) {
        allItems = buildItems(mode, query);
        filtered = query ? allItems.sort(_FormulaAutocompleteAllItemsSort).slice(0, 20) : null;
        t11 = mode === "operator" ? [
            {
                cat: {
                    id: "operators",
        ...
        ] : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"].map({
            "FormulaAutocomplete[INDICATOR_CATEGORIES.map()]": (cat)=>({
                    cat,
                    items: allItems.filter({
                        "FormulaAutocomplete[INDICATOR_CATEGORIES.map() > allItems.filter()]": (it)=>it.categoryId === cat.id
                    }["FormulaAutocomplete[INDICATOR_CATEGORIES.map() > allItems.filter()]"])
                })
        }["FormulaAutocomplete[INDICATOR_CATEGORIES.map()]"]).filter(_FormulaAutocompleteAnonymous);
        $[16] = mode;
        $[17] = query;
        $[18] = allItems;
        $[19] = filtered;
    ...
    let t12;
    let t13;
    if ($[21] !== activeCategoryId || $[22] !== groups) {
        t12 = ({
            "FormulaAutocomplete[useEffect()]": ()=>{
    ...
    if ($[25] === Symbol.for("react.memo_cache_sentinel")) {
        t14 = ({
            "FormulaAutocomplete[scrollToCategory]": (catId)=>{
                const el_0 = categoryRefs.current.get(catId);
                if (el_0 && valuesScrollRef.current) {
                    const container = valuesScrollRef.current;
                    container.getBoundingClientRect();
                    el_0.getBoundingClientRect();
                    const scrollTop = el_0.offsetTop - container.offsetTop - 8;
                    container.scrollTo({
                        top: scrollTop,
                        behavior: "smooth"
                    });
        ...
        })["FormulaAutocomplete[scrollToCategory]"];
        $[25] = t14;
    } else {
        t14 = $[25];
    }
    const scrollToCategory = t14;
    let t15;
    if ($[26] !== groups) {
        t15 = ({
            "FormulaAutocomplete[handleValuesScroll]": ()=>{
                if (!valuesScrollRef.current) {
                    return;
                }
                const container_0 = valuesScrollRef.current;
                const scrollTop_0 = container_0.scrollTop;
                for (const group of groups){
                    const el_1 = categoryRefs.current.get(group.cat.id);
                    if (el_1) {
                        const offsetTop = el_1.offsetTop - container_0.offsetTop;
                        if (scrollTop_0 >= offsetTop - 50) {
    ...
    const handleValuesScroll = t15;
    let t16;
    let t17;
    if ($[28] !== activeCategoryId || $[29] !== allItems || $[30] !== filtered || $[31] !== focusPanel || $[32] !== groups || $[33] !== onSelect || $[34] !== selectedIndex) {
        t16 = ({
            "FormulaAutocomplete[useEffect()]": ()=>{
                const handleKeyDown = {
                    "FormulaAutocomplete[useEffect() > handleKeyDown]": (e_0)=>{
                        const ce = e_0;
                        ...
                        if (key === "ArrowDown") {
                            if (focusPanel === "category") {
                                const currentIdx = groups.findIndex({
                                    "FormulaAutocomplete[useEffect() > handleKeyDown > groups.findIndex()]": (g_0)=>g_0.cat.id === activeCategoryId
                                }["FormulaAutocomplete[useEffect() > handleKeyDown > groups.findIndex()]"]);
                                ...
                                setSelectedIndex({
                                    "FormulaAutocomplete[useEffect() > handleKeyDown > setSelectedIndex()]": (prev)=>(prev + 1) % list.length
                                }["FormulaAutocomplete[useEffect() > handleKeyDown > setSelectedIndex()]"]);
                            }
                        } else {
                            if (key === "ArrowUp") {
                                if (focusPanel === "category") {
                                    const currentIdx_0 = groups.findIndex({
                                        "FormulaAutocomplete[useEffect() > handleKeyDown > groups.findIndex()]": (g_1)=>g_1.cat.id === activeCategoryId
                                    }["FormulaAutocomplete[useEffect() > handleKeyDown > groups.findIndex()]"]);
                                    const nextIdx_0 = (currentIdx_0 - 1 + groups.length) % groups.length;
                                    const nextCat_0 = groups[nextIdx_0].cat.id;
                                    setActiveCategoryId(nextCat_0);
                                    scrollToCategory(nextCat_0);
                                } else {
                                    setSelectedIndex({
                                        "FormulaAutocomplete[useEffect() > handleKeyDown > setSelectedIndex()]": (prev_0)=>(prev_0 - 1 + list.length) % list.length
                                    }["FormulaAutocomplete[useEffect() > handleKeyDown > setSelectedIndex()]"]);
                                }
                            } else {
                                if (key === "ArrowLeft") {
                ...
                }["FormulaAutocomplete[useEffect() > handleKeyDown]"];
    ...
    let t21;
    let t22;
    if ($[37] !== activeCategoryId || $[38] !== allItems || $[39] !== currentPos.left || $[40] !== currentPos.top || $[41] !== filtered || $[42] !== focusPanel || $[43] !== groups || $[44] !== handleValuesScroll || $[45] !== onSelect || $[46] !== selectedIndex) {
        const renderFiltered = {
            "FormulaAutocomplete[renderFiltered]": ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "py-1",
                    children: [
                        (filtered ?? []).map({
                            "FormulaAutocomplete[renderFiltered > (anonymous)()]": (item, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ItemRow, {
                                    item: item,
                        ...
                        }["FormulaAutocomplete[renderFiltered > (anonymous)()]"]),
        ...
        }["FormulaAutocomplete[renderFiltered]"];
        t18 = ref;
        t19 = "fixed z-[9999] rounded-xl border border-border bg-popover shadow-2xl overflow-hidden flex flex-col";
        const t23 = `${currentPos.top}px`;
        const t24 = `${currentPos.left}px`;
        const t25 = filtered ? 320 : 520;
        const t26 = currentPos.top === 0 && currentPos.left === 0 ? 0 : 1;
        const t27 = currentPos.top === 0 && currentPos.left === 0 ? "none" : "auto";
        if ($[52] !== t23 || $[53] !== t24 || $[54] !== t25 || $[55] !== t26 || $[56] !== t27) {
            t20 = {
                top: t23,
                left: t24,
                maxHeight: 600,
        ...
        t21 = _FormulaAutocompleteDivOnMouseDown;
        t22 = filtered ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "py-1",
                        children: groups.map({
                            "FormulaAutocomplete[groups.map()]": (t28)=>{
                                const { cat: cat_0 } = t28;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: {
                                        "FormulaAutocomplete[groups.map() > <button>.onClick]": ()=>{
                                            setActiveCategoryId(cat_0.id);
                                            scrollToCategory(cat_0.id);
                                            setFocusPanel("value");
                                        }
                                    }["FormulaAutocomplete[groups.map() > <button>.onClick]"],
                                    className: `w-full text-left px-3 py-2 text-xs font-medium transition-colors ${activeCategoryId === cat_0.id ? "bg-amber-500/10 text-amber-500 border-r-2 border-amber-500" : "text-muted-foreground hover:bg-accent hover:text-foreground"} ${focusPanel === "category" && activeCategoryId === cat_0.id ? "ring-1 ring-amber-500/30" : ""}`,
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: catColour(cat_0.id),
                        ...
                        }["FormulaAutocomplete[groups.map()]"])
                    }, void 0, false, {
                        fileName: "[project]/src/components/screener/FormulaAutocomplete.tsx",
                        lineNumber: 574,
                        columnNumber: 83
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "py-1",
                        children: groups.map({
                            "FormulaAutocomplete[groups.map()]": (t29)=>{
                                const { cat: cat_1, items } = t29;
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ref: {
                                        "FormulaAutocomplete[groups.map() > <div>.ref]": (el_2)=>{
                                            if (el_2) {
                                                categoryRefs.current.set(cat_1.id, el_2);
                                            }
                                        }
                                    }["FormulaAutocomplete[groups.map() > <div>.ref]"],
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            className: `px-3 pt-2 pb-0.5 text-[10px] font-semibold uppercase tracking-widest sticky top-0 bg-popover/95 backdrop-blur-sm z-10 ${catColour(cat_1.id)}`,
                                            children: cat_1.label
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/screener/FormulaAutocomplete.tsx",
                                            lineNumber: 599,
                                            columnNumber: 67
                                        ...
                                        items.map({
                                            "FormulaAutocomplete[groups.map() > items.map()]": (item_0, i_0)=>{
                                                const globalIdx = allItems.indexOf(item_0);
                                        ...
                                        }["FormulaAutocomplete[groups.map() > items.map()]"])
                                    ]
                                }, cat_1.id, true, {
                                    fileName: "[project]/src/components/screener/FormulaAutocomplete.tsx",
                                    lineNumber: 593,
    ...
    let t24;
    if ($[59] !== t18 || $[60] !== t19 || $[61] !== t20 || $[62] !== t21 || $[63] !== t22) {
    ...
    const dropdownGrid = t24;
    const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t25;
    let t26;
    if ($[65] === Symbol.for("react.memo_cache_sentinel")) {
        t25 = ({
            "FormulaAutocomplete[useEffect()]": ()=>setMounted(true)
        })["FormulaAutocomplete[useEffect()]"];
        t26 = [];
        $[65] = t25;
        $[66] = t26;
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])(t25, t26);
    if (!mounted) {
        return null;
    }
    let t27;
    if ($[67] !== dropdownGrid) {
        t27 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(dropdownGrid, document.body);
        $[67] = dropdownGrid;
        $[68] = t27;
    } else {
        t27 = $[68];
...
_s(FormulaAutocomplete, "0dmF+892Qy33OpsNdUHlrB0SWPI=");
_c1 = FormulaAutocomplete;
// ─── single row ──────────────────────────────────────────────────────────────
function _FormulaAutocompleteDivOnMouseDown(e_1) {
    return e_1.preventDefault();
}
function _FormulaAutocompleteAnonymous(g) {
    return g.items.length > 0;
}
function _FormulaAutocompleteAllItemsSort(a, b) {
...
function ItemRow(t0) {
    ...
    const { item, isSelected, selRef, onSelect } = t0;
    const t1 = selRef ?? null;
    let t2;
    if ($[1] !== item || $[2] !== onSelect) {
        t2 = ({
            "ItemRow[<button>.onMouseDown]": (e)=>{
                e.preventDefault();
                onSelect(item);
            }
        })["ItemRow[<button>.onMouseDown]"];
        $[1] = item;
        $[2] = onSelect;
        $[3] = t2;
    } else {
    ...
    const t3 = `w-full flex items-center gap-2 px-3 py-1.5 text-left transition-colors ${isSelected ? "bg-amber-500/10" : "hover:bg-accent"}`;
    const t4 = `text-[13px] font-medium truncate ${isSelected ? "text-amber-400" : "text-foreground"}`;
    let t5;
    if ($[4] !== item.label || $[5] !== item.matchIndices) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Highlight, {
            text: item.label,
    ...
    let t7;
    if ($[10] !== item.dslExample || $[11] !== item.label) {
        t7 = item.dslExample && item.dslExample !== item.label && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    let t9;
    if ($[16] !== item.dslName || $[17] !== item.type) {
        t9 = item.type === "operator" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
    ...
    let t10;
    if ($[19] !== t1 || $[20] !== t2 || $[21] !== t3 || $[22] !== t8 || $[23] !== t9) {
...
__turbopack_context__.k.register(_c1, "FormulaAutocomplete");
__turbopack_context__.k.register(_c2, "ItemRow");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/screener/FormulaCell.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$FormulaAutocomplete$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screener/FormulaAutocomplete.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/screener/indicators.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
/**
...
function buildDslFromTokens(t) {
    ...
    const lhsInd = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === t.lhsId);
    if (!lhsInd) return '';
    ...
    const op = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find((o)=>o.id === t.opId);
    if (!op) return lhs;
    if (op.valueConfig.type === 'none') return `${lhs} ${op.dslOp}`;
    let rhs = t.rhsValue;
    if (t.rhsType === 'indicator' && t.rhsValue) {
        const rhsInd = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === t.rhsValue);
        if (rhsInd) {
            rhs = rhsInd.dslName;
...
function Chip(t0) {
    ...
    if ($[0] !== "bc475d75d8158e6154ae0e46e7b98d02a49d791267a89be17fc0f033023b5295") {
        for(let $i = 0; $i < 15; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "bc475d75d8158e6154ae0e46e7b98d02a49d791267a89be17fc0f033023b5295";
    }
    const { label, placeholder, active, query, onQueryChange, onClick, onKeyDown, compact: t1, isOperator: t2 } = t0;
    const compact = t1 === undefined ? false : t1;
    const isOperator = t2 === undefined ? false : t2;
    const isEmpty = !label && !active;
    let t3;
    if ($[1] !== onClick) {
        t3 = ({
            "Chip[<button>.onMouseDown]": (e)=>{
                e.stopPropagation();
                onClick(e);
            }
        })["Chip[<button>.onMouseDown]"];
        $[1] = onClick;
        $[2] = t3;
    } else {
        t3 = $[2];
    }
    const t4 = `inline-flex items-center gap-1 rounded cursor-pointer ${compact ? "px-0 py-0.5 text-[13px]" : "px-0 py-0.5 text-[15px]"} font-medium transition-all duration-200 active:scale-[0.97] select-none ${compact ? "min-h-[20px]" : "min-h-[24px]"} leading-none
    ...
    let t5;
    if ($[3] !== active || $[4] !== isEmpty || $[5] !== label || $[6] !== onKeyDown || $[7] !== onQueryChange || $[8] !== placeholder || $[9] !== query) {
        t5 = active && onQueryChange !== undefined ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
            autoFocus: true,
            value: query ?? "",
            onChange: {
                "Chip[<input>.onChange]": (e_0)=>onQueryChange(e_0.target.value)
            }["Chip[<input>.onChange]"],
            onKeyDown: onKeyDown,
            ...
            onMouseDown: _ChipInputOnMouseDown
        }, void 0, false, {
            fileName: "[project]/src/components/screener/FormulaCell.tsx",
            lineNumber: 119,
            columnNumber: 50
        }, this) : isEmpty ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_c = Chip;
// ─── main component ───────────────────────────────────────────────────────────
function _ChipInputOnMouseDown(e_1) {
...
function FormulaCell({ criterion, index, onToggle, onRemove, onUpdate, onReorder }) {
    ...
    const [tokens, setTokens] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "FormulaCell.useState": ()=>parseTokensFromCriterion(criterion)
    }["FormulaCell.useState"]);
            ...
            if (!criterion.dslString && !criterion.indicatorId) {
                ...
                if (el) {
                    ...
                    requestAnimationFrame({
                        "FormulaCell.useEffect": ()=>{
                            setTimeout({
                                "FormulaCell.useEffect": ()=>openSlot('lhs', el)
                            }["FormulaCell.useEffect"], 50);
                        }
                    }["FormulaCell.useEffect"]);
                }
            }
    ...
    function openSlot(slot, el_0) {
        let attempts = 0;
        const maxAttempts = 10;
        const calculate = ()=>{
            const r = el_0.getBoundingClientRect();
    ...
    function handleSelect(item) {
        ...
        if (activeSlot === 'lhs') {
            const ind = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === item.id);
            ...
            const el_1 = cellRef.current?.querySelector('[data-slot="op"] button');
            if (el_1) setTimeout(()=>openSlot('op', el_1), 50);
            else closeSlot();
            ...
            const op = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find((o)=>o.id === item.id);
            if (!op || op.valueConfig.type === 'none') {
                closeSlot();
                return;
            }
            const el_2 = cellRef.current?.querySelector('[data-slot="rhs"] button');
            if (el_2) setTimeout(()=>openSlot(op.rhsCanBeIndicator ? 'rhs' : 'rhs-value', el_2), 50);
            else closeSlot();
        } else if (activeSlot === 'rhs') {
            const ind_0 = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i_0)=>i_0.id === item.id);
            const params_0 = ind_0?.params.map((p_0)=>p_0.defaultValue) ?? [];
            commit({
                ...tokens,
                rhsType: 'indicator',
                rhsValue: item.id,
            ...
            const idx_0 = parseInt(activeSlot.split('-')[2]);
            const newParams_0 = [
                ...tokens.rhsParams
            ];
            newParams_0[idx_0] = val;
            commit({
                ...tokens,
                rhsParams: newParams_0
            });
            closeSlot();
        }
    }
    ...
    // ── drag ──
    const handleDragStart = (e_0)=>{
        if (activeSlot) return;
        setIsDragging(true);
        e_0.dataTransfer.effectAllowed = 'move';
        e_0.dataTransfer.setData('text/plain', index.toString());
    };
    const handleDragEnd = ()=>{
        setIsDragging(false);
        setIsDragOver(false);
    };
    const handleDragOver = (e_1)=>{
        if (activeSlot) return;
        e_1.preventDefault();
        e_1.dataTransfer.dropEffect = 'move';
        setIsDragOver(true);
    };
    ...
    const handleDrop = (e_2)=>{
        e_2.preventDefault();
        setIsDragOver(false);
        const from = parseInt(e_2.dataTransfer.getData('text/plain'));
        if (!isNaN(from) && from !== index && onReorder) onReorder(from, index);
    };
    const [tfOpen, setTfOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const tfRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const [tfDropdownPos, setTfDropdownPos] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        top: 0,
        left: 0
    });
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FormulaCell.useEffect": ()=>{
            if (!tfOpen) return;
            const handler = {
                "FormulaCell.useEffect.handler": (e_3)=>{
                    if (tfRef.current && !tfRef.current.contains(e_3.target)) setTfOpen(false);
                }
            }["FormulaCell.useEffect.handler"];
            document.addEventListener('mousedown', handler);
            return ({
                "FormulaCell.useEffect": ()=>document.removeEventListener('mousedown', handler)
            })["FormulaCell.useEffect"];
        }
    }["FormulaCell.useEffect"], [
        tfOpen
    ...
    const InteractiveExpr = ({ prefix, indId, params: params_1 })=>{
        const ind_1 = indId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i_1)=>i_1.id === indId) : null;
        if (!ind_1) {
            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                "data-slot": prefix,
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
                    ...
                    onClick: (e_4)=>openSlot(prefix, e_4.currentTarget)
                }, void 0, false, {
                    fileName: "[project]/src/components/screener/FormulaCell.tsx",
                    lineNumber: 364,
                    columnNumber: 21
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            children: [
                prefix === 'lhs' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ref: tfRef,
                    className: "relative",
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onMouseDown: (e_5)=>{
                                e_5.stopPropagation();
                                const rect = e_5.currentTarget.getBoundingClientRect();
                                const dropdownHeight = 300;
                                const dropdownWidth_0 = Math.max(longestString.length * 8 + 40, 100);
                                ...
                                if (left + dropdownWidth_0 > viewportWidth) {
                                    // Align to right edge
                                    left = viewportWidth - dropdownWidth_0 - 10;
                                }
                                setTfDropdownPos({
                                    top,
                                    left
                        ...
                        tfOpen && typeof document !== 'undefined' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2d$dom$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createPortal"])(/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: Object.entries(TIMEFRAME_CATEGORIES).map(([category, options])=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            options.map((tf)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onMouseDown: (e_6)=>{
                                                        e_6.stopPropagation();
                                                        setTokens((prev)=>({
                                                                ...prev,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
                        label: ind_1.label,
                        placeholder: ind_1.label,
                        active: activeSlot === prefix,
                        query: activeSlot === prefix ? searchQuery : undefined,
                        onQueryChange: setSearchQuery,
                        onKeyDown: handleKeyDown,
                        onClick: (e_7)=>openSlot(prefix, e_7.currentTarget),
                        compact: true
                    }, void 0, false, {
                        fileName: "[project]/src/components/screener/FormulaCell.tsx",
                        lineNumber: 425,
                ...
                ind_1.params.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                    children: [
                        ...
                        ind_1.params.map((p_1, i_2)=>{
                            const val_0 = params_1[i_2] ?? p_1.defaultValue;
                            const slotName = `${prefix}-param-${i_2}`;
                            const isParamActive = activeSlot === slotName;
                            let displayVal = String(val_0);
                            if (typeof val_0 === 'string' && __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].some((ind_3)=>ind_3.id === val_0)) {
                                displayVal = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((ind_2)=>ind_2.id === val_0)?.label || val_0;
                            }
                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].Fragment, {
                                children: [
                                    i_2 > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-foreground font-mono text-[13px]",
                                        children: ","
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/screener/FormulaCell.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
                                            label: displayVal,
                                            placeholder: p_1.name,
                                            active: isParamActive,
                                            query: isParamActive ? searchQuery : undefined,
                                            onQueryChange: setSearchQuery,
                                            onKeyDown: handleKeyDown,
                                            onClick: (e_8)=>openSlot(slotName, e_8.currentTarget),
                                            compact: true
                                        }, void 0, false, {
                                            fileName: "[project]/src/components/screener/FormulaCell.tsx",
                                            lineNumber: 441,
    ...
    const opDef = tokens.opId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find((o_0)=>o_0.id === tokens.opId) : null;
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ref: cellRef,
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InteractiveExpr, {
                        prefix: "lhs",
                        indId: tokens.lhsId,
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
                                    ...
                                    onQueryChange: setSearchQuery,
                                    onKeyDown: handleKeyDown,
                                    onClick: (e_9)=>openSlot('op', e_9.currentTarget),
                                    compact: true,
                                    isOperator: true
                                }, void 0, false, {
                                    fileName: "[project]/src/components/screener/FormulaCell.tsx",
                    ...
                    tokens.lhsId && tokens.opId && opDef && opDef.valueConfig.type !== 'none' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                "data-slot": "rhs",
                                id: `rhs-${criterion.id}`,
                                children: activeSlot === 'rhs-value' || !opDef.rhsCanBeIndicator && tokens.rhsType === 'number' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(Chip, {
                                    ...
                                    onQueryChange: setSearchQuery,
                                    onKeyDown: handleKeyDown,
                                    onClick: (e_10)=>openSlot('rhs-value', e_10.currentTarget),
                                    compact: true
                                }, void 0, false, {
                                    fileName: "[project]/src/components/screener/FormulaCell.tsx",
                                    lineNumber: 468,
                                    columnNumber: 114
                                }, this) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(InteractiveExpr, {
                                    prefix: "rhs",
                    ...
                    !criterion.supported && criterion.dslString && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                        onMouseDown: (e_12)=>{
                            e_12.stopPropagation(); /* TODO Duplicate */ 
                        },
            ...
            activeSlot && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$FormulaAutocomplete$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FormulaAutocomplete"], {
                mode: dropdownMode,
                query: searchQuery,
...
_s(FormulaCell, "2bYlZ+2pET8WyKo1z/+TH2AwWJA=");
_c1 = FormulaCell;
var _c, _c1;
__turbopack_context__.k.register(_c, "Chip");
__turbopack_context__.k.register(_c1, "FormulaCell");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/screener/ConditionBuilder.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$FormulaCell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screener/FormulaCell.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/screener/indicators.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function ParamSpinner(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(17);
    if ($[0] !== "69bec7dacb7ee27eb861bb00a97b89c1141577f2da1403495a63a7b7de60d809") {
        for(let $i = 0; $i < 17; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "69bec7dacb7ee27eb861bb00a97b89c1141577f2da1403495a63a7b7de60d809";
    }
    const { value, onChange, param, onClick } = t0;
    const isNumber = typeof value === "number" || !isNaN(Number(value)) && String(value).trim() !== "";
    if (!isNumber && typeof value === "string") {
        let t1;
        if ($[1] !== onChange) {
            t1 = ({
                "ParamSpinner[<input>.onChange]": (e)=>onChange(e.target.value)
            })["ParamSpinner[<input>.onChange]"];
            $[1] = onChange;
            $[2] = t1;
        } else {
            t1 = $[2];
        ...
        let t2;
        if ($[3] !== onClick || $[4] !== param.label || $[5] !== t1 || $[6] !== value) {
    ...
    const t1 = param.step ?? 1;
    let t2;
    if ($[8] !== onChange) {
        t2 = ({
            "ParamSpinner[<input>.onChange]": (e_0)=>{
                const val = parseFloat(e_0.target.value);
                if (!isNaN(val)) {
                    onChange(val);
                }
            }
    ...
    let t3;
    if ($[10] !== onClick || $[11] !== param.max || $[12] !== param.min || $[13] !== t1 || $[14] !== t2 || $[15] !== value) {
...
function ConditionBuilder({ filters, onChange, onRun, rulesViewMode, screenName }) {
    ...
    const [visualBuilderOpen, setVisualBuilderOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // ── Visual builder state ──────────────────────────────────────────────
    const [selectedCatId, setSelectedCatId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"][0].id);
    const [selectedLhsId, setSelectedLhsId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [lhsParams, setLhsParams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    const [selectedOpId, setSelectedOpId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // RHS — either "number" mode or "indicator" mode
    const [rhsMode, setRhsMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('number');
    const [rhsNumber, setRhsNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [rhsNumber2, setRhsNumber2] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // for "between"
    const [rhsIndId, setRhsIndId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [rhsIndParams, setRhsIndParams] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({});
    // Active criteria
    ...
    const [dslInput, setDslInput] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    // ── Save ─────────────────────────────────────────────────────────────
    const [saveScreenName, setSaveScreenName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [isSaving, setIsSaving] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // ── Derived ───────────────────────────────────────────────────────────
    const lhsIndicators = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].filter((i)=>i.categoryId === selectedCatId);
    const lhsInd = selectedLhsId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === selectedLhsId) ?? null : null;
    const selectedOp = selectedOpId ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find((o)=>o.id === selectedOpId) ?? null : null;
    ...
    const availableOps = isLhsEnum ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].filter((o)=>o.id === 'eq' || o.id === 'gt') : isLhsFund ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].filter((o)=>!o.technicalOnly) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConditionBuilder.useEffect": ()=>{
            if (!lhsInd) return;
            const def = {};
            lhsInd.params.forEach({
                "ConditionBuilder.useEffect": (p)=>{
            ...
            if (lhsInd.rhsType === 'enum') {
                ...
                const eqOp = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find({
                    "ConditionBuilder.useEffect.eqOp": (o)=>o.id === 'eq' || o.id === 'gt'
                }["ConditionBuilder.useEffect.eqOp"]);
                if (eqOp) setSelectedOpId(eqOp.id);
            } else {
                const firstOp = isLhsFund ? __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"].find({
                    "ConditionBuilder.useEffect": (o)=>!o.technicalOnly
                }["ConditionBuilder.useEffect"]) : __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["OPERATORS"][0];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConditionBuilder.useEffect": ()=>{
            const first = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find({
                "ConditionBuilder.useEffect.first": (i)=>i.categoryId === selectedCatId
            }["ConditionBuilder.useEffect.first"]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ConditionBuilder.useEffect": ()=>{
            if (!rhsIndId) return;
            const ind = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find({
                "ConditionBuilder.useEffect.ind": (i)=>i.id === rhsIndId
            }["ConditionBuilder.useEffect.ind"]);
            if (!ind) return;
            const def = {};
            ind.params.forEach({
                "ConditionBuilder.useEffect": (p)=>{
    ...
    // ── DSL build helpers ─────────────────────────────────────────────────
    const buildLhsDsl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ConditionBuilder.useCallback[buildLhsDsl]": ()=>{
            if (!lhsInd) return '';
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dslExpr"])(lhsInd, lhsInd.params.map({
                "ConditionBuilder.useCallback[buildLhsDsl]": (p)=>lhsParams[p.name] ?? p.defaultValue
            }["ConditionBuilder.useCallback[buildLhsDsl]"]));
        }
    }["ConditionBuilder.useCallback[buildLhsDsl]"], [
        lhsInd,
    ...
    const buildRhsDsl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ConditionBuilder.useCallback[buildRhsDsl]": ()=>{
            ...
            if (rhsMode === 'indicator' && rhsIndId) {
                const rInd = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find({
                    "ConditionBuilder.useCallback[buildRhsDsl].rInd": (i)=>i.id === rhsIndId
                }["ConditionBuilder.useCallback[buildRhsDsl].rInd"]);
                if (!rInd) return '';
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["dslExpr"])(rInd, rInd.params.map({
                    "ConditionBuilder.useCallback[buildRhsDsl]": (p)=>rhsIndParams[p.name] ?? p.defaultValue
                }["ConditionBuilder.useCallback[buildRhsDsl]"]));
            }
            return rhsNumber;
        }
    ...
    const handleAddCriterion = ()=>{
        ...
        if (lhsInd.rhsType === 'enum' && lhsInd.enumOptions) {
            ...
            const rInd = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATORS"].find((i)=>i.id === rhsIndId);
        ...
        const dslString = vcl.type === 'two_numbers' ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDslCriterion"])(lhsExpr, selectedOp, rhsNumber, Number(rhsNumber2), lhsInd) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDslCriterion"])(lhsExpr, selectedOp, rhsExpr, undefined, lhsInd);
        const newCrit = {
            id: `crit-${Date.now()}`,
    ...
    const handleSaveScreen = async ()=>{
        ...
        setIsSaving(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])('/api/screener/screens', {
                name: saveScreenName,
                filtersJson: filters
            });
            setSaveScreenName('');
            ...
            alert(error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ApiError"] ? `Error: ${error.message}` : 'Failed to save screen');
        } finally{
            setIsSaving(false);
        }
    };
    ...
    const livePreview = (()=>{
        ...
        return vc?.type === 'two_numbers' && rhsNumber2 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDslCriterion"])(l, selectedOp, rhsNumber, Number(rhsNumber2), lhsInd ?? undefined) : (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["buildDslCriterion"])(l, selectedOp, r, undefined, lhsInd ?? undefined);
    })();
    // ── Universe dropdown shortcut ────────────────────────────────────────
    const univCfg = lhsInd ? UNIVERSE_OPTIONS[lhsInd.id] : undefined;
    // ── Visual Builder Renderer ───────────────────────────────────────────
    const renderVisualBuilder = ()=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$screener$2f$indicators$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["INDICATOR_CATEGORIES"].map((cat)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                !ind.supported && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                isActive && ind.params.map((p)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ParamSpinner, {
                                                        param: p,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex-1 overflow-y-auto p-2 flex flex-col gap-0.5 custom-scrollbar",
                            children: availableOps.map((op)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: !selectedOp ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 553,
                                columnNumber: 36
                            }, this) : vc?.type === 'none' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                lineNumber: 555,
                                columnNumber: 56
                            }, this) : isLhsEnum && lhsInd?.enumOptions && lhsInd.enumOptions.length > 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "flex flex-col h-full overflow-hidden",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "flex-1 overflow-y-auto p-2 flex flex-col gap-0.5 custom-scrollbar",
                                        children: lhsInd.enumOptions.map((opt)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: vc.type === 'two_numbers' ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    opCanBeInd && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            livePreview && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    rulesViewMode === 'formula' ? /* ── DSL Mode: single textarea, no criteria list shown ── */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            criteria.filter((c)=>c.enabled && c.dslString).length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: criteria.filter((c)=>c.enabled && c.dslString).map((c)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        lineNumber: 634,
                        columnNumber: 7
                    }, this) : /* ── List Mode: chip rows ── */ /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "flex flex-col",
                        children: criteria.length === 0 && !dslInput ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                criteria.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: criteria.map((crit, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$FormulaCell$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["FormulaCell"], {
                                            criterion: crit,
                                            index: i,
                                ...
                                dslInput.trim() && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        dslInput.split('\n').filter((l)=>l.trim()).map((l, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(ConditionBuilder, "g2NjEfPr2IGb7mODhDWOkH13tCQ=");
_c1 = ConditionBuilder;
var _c, _c1;
__turbopack_context__.k.register(_c, "ParamSpinner");
__turbopack_context__.k.register(_c1, "ConditionBuilder");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
;
;
const badgeVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center rounded-full border border-transparent px-2.5 py-1 text-xs font-medium w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-[var(--brand-focus)] focus-visible:ring-2 focus-visible:ring-[var(--brand-focus)] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow,background-color,border-color] overflow-hidden", {
    variants: {
        variant: {
...
function Badge(t0) {
    ...
    if ($[0] !== "27dc3d00940477cbbf9e957ddc759366491e871cf31f50464b36d07936f55668") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "27dc3d00940477cbbf9e957ddc759366491e871cf31f50464b36d07936f55668";
    }
    let className;
    let props;
    let t1;
...
"[project]/src/app/(app)/screener/run/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$ConditionBuilder$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/screener/ConditionBuilder.tsx [app-client] (ecmascript)");
...
function ScreenerRunPage() {
    ...
    const [rulesViewMode, setRulesViewMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('list');
    ...
    const handleRun = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ScreenerRunPage.useCallback[handleRun]": async ()=>{
            setIsLoading(true);
            setError(null);
            try {
                const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiPost"])("/api/screener/run", {
                    filters
                });
    ...
    }["ScreenerRunPage.useCallback[handleRun]"], [
        filters
    ]);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$screener$2f$ConditionBuilder$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                filters: filters,
                onChange: setFilters,
                onRun: handleRun,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    !hasResults && !error ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                ...
                                                                children: r.pctChange != null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                className: "px-4 py-2.5 text-right",
                                                                children: r.rsi14 != null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
_s(ScreenerRunPage, "dA8sEBfms5TUWZcJnrB9JnytSnA=");
_c = ScreenerRunPage;
var _c;
__turbopack_context__.k.register(_c, "ScreenerRunPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_adb92d4e._.js.map