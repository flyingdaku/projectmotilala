...
"[project]/node_modules/react-grid-layout/dist/chunk-YFVX5RDK.mjs [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useContainerWidth(options = {}) {
    ...
    const [mounted, setMounted] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(!measureBeforeMount);
    ...
    const measureWidth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useContainerWidth.useCallback[measureWidth]": ()=>{
...
function useGridLayout(options) {
    const { layout: propsLayout, cols, preventCollision = false, onLayoutChange, compactor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verticalCompactor"] } = options;
    ...
    const [layout, setLayoutState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useGridLayout.useState": ()=>{
            const corrected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["correctBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(propsLayout), {
                cols
            });
            return compactor.compact(corrected, cols);
        }
    ...
    const [resizeState, setResizeState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        resizing: false,
        oldResizeItem: null,
        oldLayout: null
    });
    const [dropState, setDropState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        droppingDOMNode: null,
        droppingPosition: null
    });
    const prevLayoutRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(layout);
    const setLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[setLayout]": (newLayout)=>{
            const corrected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["correctBounds"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(newLayout), {
                cols
            });
            const compacted = compactor.compact(corrected, cols);
            setLayoutState(compacted);
        }
    }["useGridLayout.useCallback[setLayout]"], [
        cols,
        compactor
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGridLayout.useEffect": ()=>{
            if (isDraggingRef.current) return;
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$equals$2f$dist$2f$fast$2d$equals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(propsLayout, prevLayoutRef.current)) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useGridLayout.useEffect": ()=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$equals$2f$dist$2f$fast$2d$equals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(layout, prevLayoutRef.current)) {
                prevLayoutRef.current = layout;
                onLayoutChange?.(layout);
            }
        }
    ...
    const onDragStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDragStart]": (itemId, x, y)=>{
            const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayoutItem"])(layout, itemId);
            if (!item) return null;
            isDraggingRef.current = true;
            const placeholder = {
                ...(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayoutItem"])(item),
                x,
                y,
                static: false,
                moved: false
            ...
            setDragState({
                ...
                oldDragItem: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayoutItem"])(item),
                oldLayout: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(layout)
            });
            return placeholder;
        }
    }["useGridLayout.useCallback[onDragStart]"], [
        layout
    ]);
    const onDrag = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDrag]": (itemId, x, y)=>{
            const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayoutItem"])(layout, itemId);
            if (!item) return;
            setDragState({
                "useGridLayout.useCallback[onDrag]": (prev)=>({
                        ...prev,
            ...
            }["useGridLayout.useCallback[onDrag]"]);
            const newLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["moveElement"])(layout, item, x, y, true, // isUserAction
    ...
    const onDragStop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDragStop]": (itemId, x, y)=>{
            const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayoutItem"])(layout, itemId);
            if (!item) return;
            const newLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["moveElement"])(layout, item, x, y, true, preventCollision, compactor.type, cols, compactor.allowOverlap);
            const compacted = compactor.compact(newLayout, cols);
    ...
    }["useGridLayout.useCallback[onDragStop]"], [
        layout,
        cols,
        compactor,
        preventCollision
    ...
    const onResizeStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onResizeStart]": (itemId)=>{
            const item = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayoutItem"])(layout, itemId);
            if (!item) return null;
            setResizeState({
                resizing: true,
                oldResizeItem: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayoutItem"])(item),
                oldLayout: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(layout)
            });
            return item;
        }
    }["useGridLayout.useCallback[onResizeStart]"], [
        layout
    ]);
    const onResize = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onResize]": (itemId, w, h, x, y)=>{
            const newLayout = layout.map({
                "useGridLayout.useCallback[onResize].newLayout": (item)=>{
                    if (item.i === itemId) {
                        const updated = {
                            ...item,
                            w,
            ...
            }["useGridLayout.useCallback[onResize].newLayout"]);
            const corrected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["correctBounds"])(newLayout, {
                cols
            });
            const compacted = compactor.compact(corrected, cols);
            setLayoutState(compacted);
        }
    }["useGridLayout.useCallback[onResize]"], [
        layout,
        cols,
        compactor
    ]);
    const onResizeStop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onResizeStop]": (itemId, w, h)=>{
            onResize(itemId, w, h);
            setResizeState({
                resizing: false,
                oldResizeItem: null,
    ...
    }["useGridLayout.useCallback[onResizeStop]"], [
        onResize
    ]);
    const onDropDragOver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDropDragOver]": (droppingItem, position)=>{
            const existingItem = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getLayoutItem"])(layout, droppingItem.i);
            if (!existingItem) {
                const newLayout = [
                    ...layout,
                    droppingItem
    ...
    }["useGridLayout.useCallback[onDropDragOver]"], [
        layout,
        cols,
        compactor
    ]);
    const onDropDragLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDropDragLeave]": ()=>{
            const newLayout = layout.filter({
                "useGridLayout.useCallback[onDropDragLeave].newLayout": (item)=>item.i !== "__dropping-elem__"
            }["useGridLayout.useCallback[onDropDragLeave].newLayout"]);
    ...
    const onDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useGridLayout.useCallback[onDrop]": (droppingItem)=>{
            const newLayout = layout.map({
                "useGridLayout.useCallback[onDrop].newLayout": (item)=>{
            ...
            }["useGridLayout.useCallback[onDrop].newLayout"]);
            const corrected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["correctBounds"])(newLayout, {
                cols
            });
            const compacted = compactor.compact(corrected, cols);
    ...
    }["useGridLayout.useCallback[onDrop]"], [
        layout,
        cols,
        compactor
    ]);
    const containerHeight = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useGridLayout.useMemo[containerHeight]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bottom"])(layout)
    }["useGridLayout.useMemo[containerHeight]"], [
        layout
    ]);
...
function useResponsiveLayout(options) {
    const { width, breakpoints = DEFAULT_BREAKPOINTS, cols: colsConfig = DEFAULT_COLS, layouts: propsLayouts = {}, compactor = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["verticalCompactor"], onBreakpointChange, onLayoutChange, onWidthChange } = options;
    const sortedBreakpoints = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useResponsiveLayout.useMemo[sortedBreakpoints]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sortBreakpoints"])(breakpoints)
    }["useResponsiveLayout.useMemo[sortedBreakpoints]"], [
        breakpoints
    ]);
    const initialBreakpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useResponsiveLayout.useMemo[initialBreakpoint]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBreakpointFromWidth"])(breakpoints, width)
    }["useResponsiveLayout.useMemo[initialBreakpoint]"], // Only calculate on mount, not on width changes
    // eslint-disable-next-line react-hooks/exhaustive-deps
    []);
    const initialCols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useResponsiveLayout.useMemo[initialCols]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColsFromBreakpoint"])(initialBreakpoint, colsConfig)
    }["useResponsiveLayout.useMemo[initialCols]"], [
        initialBreakpoint,
        colsConfig
    ]);
    const [breakpoint, setBreakpoint] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialBreakpoint);
    const [cols, setCols] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(initialCols);
    const [layouts, setLayoutsState] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        "useResponsiveLayout.useState": ()=>{
            const cloned = {};
            for (const bp of sortedBreakpoints){
                const layout2 = propsLayouts[bp];
                if (layout2) {
                    cloned[bp] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(layout2);
                }
            }
            return cloned;
        }
    ...
    const prevWidthRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(width);
    const prevBreakpointRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(breakpoint);
    const prevPropsLayoutsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(propsLayouts);
    const prevLayoutsRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(layouts);
    const layout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "useResponsiveLayout.useMemo[layout]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findOrGenerateResponsiveLayout"])(layouts, breakpoints, breakpoint, prevBreakpointRef.current, cols, compactor);
        }
    }["useResponsiveLayout.useMemo[layout]"], [
        layouts,
        breakpoints,
    ...
    const setLayoutForBreakpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useResponsiveLayout.useCallback[setLayoutForBreakpoint]": (bp, newLayout)=>{
            setLayoutsState({
                "useResponsiveLayout.useCallback[setLayoutForBreakpoint]": (prev)=>({
                        ...prev,
                        [bp]: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(newLayout)
                    })
            }["useResponsiveLayout.useCallback[setLayoutForBreakpoint]"]);
        }
    }["useResponsiveLayout.useCallback[setLayoutForBreakpoint]"], []);
    const setLayouts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useResponsiveLayout.useCallback[setLayouts]": (newLayouts)=>{
            const cloned = {};
            for (const bp of Object.keys(newLayouts)){
                const layoutForBp = newLayouts[bp];
                if (layoutForBp) {
                    cloned[bp] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$AWM66AWF$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cloneLayout"])(layoutForBp);
                }
            }
            setLayoutsState(cloned);
        }
    }["useResponsiveLayout.useCallback[setLayouts]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useResponsiveLayout.useEffect": ()=>{
            if (prevWidthRef.current === width) return;
            prevWidthRef.current = width;
            const newBreakpoint = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBreakpointFromWidth"])(breakpoints, width);
            const newCols = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getColsFromBreakpoint"])(newBreakpoint, colsConfig);
            onWidthChange?.(width, [
                10,
                10
            ...
            if (newBreakpoint !== breakpoint) {
                const newLayout = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$grid$2d$layout$2f$dist$2f$chunk$2d$XYPIYYYQ$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findOrGenerateResponsiveLayout"])(layouts, breakpoints, newBreakpoint, breakpoint, newCols, compactor);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useResponsiveLayout.useEffect": ()=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$equals$2f$dist$2f$fast$2d$equals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(propsLayouts, prevPropsLayoutsRef.current)) {
                setLayouts(propsLayouts);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useResponsiveLayout.useEffect": ()=>{
            if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$fast$2d$equals$2f$dist$2f$fast$2d$equals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deepEqual"])(layouts, prevLayoutsRef.current)) {
...
//# sourceMappingURL=node_modules_react-grid-layout_dist_d37bf5ce._.js.map