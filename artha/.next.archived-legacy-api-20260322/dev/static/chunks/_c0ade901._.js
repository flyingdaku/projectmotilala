...
function useTheme() {
    ...
    if ($[0] !== "a70315f2bdf9d9dd97993c2a01e850ba22ad9a58644598bae355ea9a4122de36") {
        for(let $i = 0; $i < 1; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a70315f2bdf9d9dd97993c2a01e850ba22ad9a58644598bae355ea9a4122de36";
    }
...
function isAppearanceConfig(value) {
    if (!value || typeof value !== "object") return false;
    const appearance = value;
    return [
        "comfortable",
        "compact"
    ].includes(String(appearance.density)) && [
        "sharp",
        "rounded",
        "soft"
    ].includes(String(appearance.radius)) && [
        "soft",
        "balanced",
        "strong"
    ].includes(String(appearance.surfaceContrast)) && [
        "balanced",
        "vivid"
    ].includes(String(appearance.chartContrast));
}
function ThemeProvider(t0) {
    ...
    const [appearance, setAppearance] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(DEFAULT_APPEARANCE);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "ThemeProvider[updateDOM]": (newTheme)=>{
        ...
        })["ThemeProvider[updateDOM]"];
        $[1] = t1;
    } else {
        t1 = $[1];
    }
    const updateDOM = t1;
    const applyAppearance = _ThemeProviderApplyAppearance;
    let t2;
    let t3;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "ThemeProvider[useEffect()]": ()=>{
                ...
                const t = setTimeout({
                    "ThemeProvider[useEffect() > setTimeout()]": ()=>{
                ...
                }["ThemeProvider[useEffect() > setTimeout()]"], 0);
                const mediaQuery = window.matchMedia("(prefers-color-scheme: dark)");
                const handleChange = {
                    "ThemeProvider[useEffect() > handleChange]": ()=>{
                        setThemeState({
                            "ThemeProvider[useEffect() > handleChange > setThemeState()]": (current)=>{
                                if (current === "system") {
                                    updateDOM("system");
                                }
                                return current;
                            }
                        }["ThemeProvider[useEffect() > handleChange > setThemeState()]"]);
                    }
                }["ThemeProvider[useEffect() > handleChange]"];
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "ThemeProvider[setTheme]": (newTheme_0)=>{
                setThemeState(newTheme_0);
                localStorage.setItem(THEME_STORAGE_KEY, newTheme_0);
                updateDOM(newTheme_0);
            }
    ...
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t5 = ({
            "ThemeProvider[updateAppearance]": (patch)=>{
                setAppearance({
                    "ThemeProvider[updateAppearance > setAppearance()]": (current_0)=>{
                        const next = {
                            ...current_0,
                            ...patch
                        };
                ...
                }["ThemeProvider[updateAppearance > setAppearance()]"]);
            }
    ...
    const resetAppearance = t6;
    let t7;
    if ($[7] !== appearance || $[8] !== resolvedTheme || $[9] !== theme) {
        t7 = {
            theme,
            resolvedTheme,
            appearance,
...
_s1(ThemeProvider, "ryViB9XznxMfBIczh0tztaCZoNE=");
_c = ThemeProvider;
function _ThemeProviderApplyAppearance(config) {
    const root_0 = document.documentElement;
    root_0.dataset.density = config.density;
    root_0.dataset.radius = config.radius;
    root_0.dataset.surfaceContrast = config.surfaceContrast;
    root_0.dataset.chartContrast = config.chartContrast;
}
var _c;
...
"[project]/src/contexts/watchlist-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const WatchlistContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])({
    isWatchlistOpen: false,
    toggleWatchlist: ()=>{},
    openWatchlist: ()=>{},
    closeWatchlist: ()=>{}
});
function WatchlistProvider(t0) {
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(9);
    if ($[0] !== "eb3462094c02f9ef57ec2323751584d55af441fee0d4a15ecdd4c964715af5c8") {
        for(let $i = 0; $i < 9; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "eb3462094c02f9ef57ec2323751584d55af441fee0d4a15ecdd4c964715af5c8";
    }
    const { children } = t0;
    const [isWatchlistOpen, setIsWatchlistOpen] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "WatchlistProvider[toggleWatchlist]": ()=>setIsWatchlistOpen(_WatchlistProviderToggleWatchlistSetIsWatchlistOpen)
        })["WatchlistProvider[toggleWatchlist]"];
        $[1] = t1;
    } else {
        t1 = $[1];
    }
    const toggleWatchlist = t1;
    let t2;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = ({
            "WatchlistProvider[openWatchlist]": ()=>setIsWatchlistOpen(true)
        })["WatchlistProvider[openWatchlist]"];
        $[2] = t2;
    } else {
        t2 = $[2];
    }
    const openWatchlist = t2;
    let t3;
    if ($[3] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "WatchlistProvider[closeWatchlist]": ()=>setIsWatchlistOpen(false)
        })["WatchlistProvider[closeWatchlist]"];
        $[3] = t3;
    } else {
        t3 = $[3];
    }
    const closeWatchlist = t3;
    let t4;
    if ($[4] !== isWatchlistOpen) {
        t4 = {
            isWatchlistOpen,
            toggleWatchlist,
            openWatchlist,
    ...
    let t5;
    if ($[6] !== children || $[7] !== t4) {
        t5 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(WatchlistContext.Provider, {
            value: t4,
            children: children
        }, void 0, false, {
            fileName: "[project]/src/contexts/watchlist-context.tsx",
            lineNumber: 74,
            columnNumber: 10
        }, this);
        $[6] = children;
...
_s(WatchlistProvider, "PMFGQvHNwiE+DwSdenFbdJCCWdw=");
_c = WatchlistProvider;
function _WatchlistProviderToggleWatchlistSetIsWatchlistOpen(prev) {
    return !prev;
}
function useWatchlist() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(WatchlistContext);
}
_s1(useWatchlist, "gDsCjeeItUuvgOWf1v4qoK9RF6k=");
var _c;
...
"[project]/src/components/layout/LayoutContent.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LayoutContent(t0) {
    ...
    if ($[0] !== "f6e9e3c15b9198c9cf7883607b2cfd1d87ec4cbb507e2a8423f1912d0a3c4fb9") {
        for(let $i = 0; $i < 4; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f6e9e3c15b9198c9cf7883607b2cfd1d87ec4cbb507e2a8423f1912d0a3c4fb9";
    }
    const { children } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Toaster"], {
            ...
            fileName: "[project]/src/components/layout/LayoutContent.tsx",
            lineNumber: 21,
            columnNumber: 10
        }, this);
        $[1] = t1;
...
//# sourceMappingURL=_c0ade901._.js.map