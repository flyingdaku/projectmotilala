    ...
    <header className="sticky top-0 z-50 w-full bg-[var(--background)]/90 backdrop-blur-md">
      <div className="container mx-auto px-4 h-12 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-lg tracking-tight" style={{ color: "var(--text-primary)" }}>Artha</span>
        </Link>
          ...
          <div className="group relative py-4">
            ...
            <div className="absolute top-[100%] left-1/2 -translate-x-1/2 w-[600px] bg-[var(--surface)] rounded-xl border border-[var(--border)] shadow-2xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 p-6 grid grid-cols-2 gap-8">
              ...
              <div className="space-y-4">
                ...
                <Link href="/backtest" className="group/item flex items-start gap-3 p-2 -mx-2 rounded-lg hover:bg-[var(--surface-hover)] transition-colors">
                ...
                <Link href="/asset-allocation" className="group/item flex items-start gap-3 p-2 -mx-2 rounded-lg hover:bg-[var(--surface-hover)] transition-colors">
                ...
                <Link href="/dynamic-allocation" className="group/item flex items-start gap-3 p-2 -mx-2 rounded-lg hover:bg-[var(--surface-hover)] transition-colors">
              ...
              <div className="space-y-4">
                ...
                <Link href="/factor-regression" className="group/item flex items-start gap-3 p-2 -mx-2 rounded-lg hover:bg-[var(--surface-hover)] transition-colors">
                ...
                <Link href="/manager-performance" className="group/item flex items-start gap-3 p-2 -mx-2 rounded-lg hover:bg-[var(--surface-hover)] transition-colors">
        ...
        <div className="flex items-center gap-3">
          <Link href="/login" className="text-xs font-medium text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
            Log In
          </Link>
          <Button asChild size="sm" className="rounded-full px-4 text-xs h-8">
