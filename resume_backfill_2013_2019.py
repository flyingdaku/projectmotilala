...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("bhavcopy_backfill_resumption.log"),
        logging.StreamHandler(sys.stdout)
    ]
)
logger = logging.getLogger(__name__)

def run_resumption_backfill():
    # Only 2013-2019 needs completion.
    # 2013 was partial, 2014-2019 was mostly missing.
    start_year = 2013
    end_year = 2019
    ...
    for year in range(start_year, end_year + 1):
        ...
        logger.info(f"=== RESUMPTION BACKFILLING YEAR {year} ===")
