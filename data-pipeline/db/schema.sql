...
-- ─── MORNINGSTAR MUTUAL FUND STAGING ──────────────────────────
...
CREATE INDEX IF NOT EXISTS idx_ms_overview_fund ON src_morningstar_fund_overview(morningstar_fund_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_perf_asset ON src_morningstar_fund_performance(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_risk_asset ON src_morningstar_fund_risk(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_portfolio_asset ON src_morningstar_fund_portfolio(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_holdings_asset ON src_morningstar_fund_holdings(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_docs_asset ON src_morningstar_fund_factsheets(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_analysis_asset ON src_morningstar_fund_analysis(asset_id);
...
CREATE INDEX IF NOT EXISTS idx_ms_mgr_asset ON src_morningstar_fund_managers(asset_id);

-- ─── MORNINGSTAR NORMALISED MF TABLES ─────────────────────────
...
CREATE INDEX IF NOT EXISTS idx_mf_trailing_asset ON mf_trailing_returns(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_calendar_asset ON mf_calendar_returns(asset_id, period_kind, period_label);
...
CREATE INDEX IF NOT EXISTS idx_mf_risk_asset ON mf_risk_metrics(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_alloc_asset ON mf_asset_allocation(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_style_asset ON mf_style_box_snapshots(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_char_asset ON mf_portfolio_characteristics(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_holdings_asset ON mf_holdings(asset_id, as_of_date DESC);
...
CREATE INDEX IF NOT EXISTS idx_mf_docs_asset ON mf_documents(asset_id, as_of_date DESC);
